    ...
    if Pose_Landmarks:
        ...
        if Pose_Landmarks[12][2] < Pose_Landmarks[24][2]:
            if Pose_Landmarks[12][1] < Pose_Landmarks[11][1]:
                ...
                AcupointsPosition[1][1][19] = (int((cx25 + cx27) // 2), int((cy27 * 8 + cy25 * 2) // 10))
                ...
                AcupointsPosition[1][1][23] = (int(cx24), int((cy24 * 2 + cy12 * 16) // 18))
                AcupointsPosition[1][1][24] = (int(cx24), int((cy24 * 3 + cy12 * 15) // 18))
                AcupointsPosition[1][1][25] = (int(cx24), int((cy24 * 4 + cy12 * 14) // 18))
                AcupointsPosition[1][1][26] = (int(cx24), int((cy24 * 5 + cy12 * 13) // 18))
                AcupointsPosition[1][1][27] = (int(cx24), int((cy24 * 7 + cy12 * 11) // 18))
                AcupointsPosition[1][1][28] = (int(cx24), int((cy24 * 9 + cy12 * 9) // 18))
                AcupointsPosition[1][1][29] = (int(cx24), int((cy24 * 10 + cy12 * 8) // 18))
                AcupointsPosition[1][1][30] = (int(cx24), int((cy24 * 11 + cy12 * 7) // 18))
                AcupointsPosition[1][1][31] = (int(cx24), int((cy24 * 12 + cy12 * 6) // 18))
                AcupointsPosition[1][1][32] = (int(cx24), int((cy24 * 16 + cy12 * 2) // 18))
                AcupointsPosition[1][1][33] = (int(cx24), int(cy24))
                AcupointsPosition[1][1][34] = (int((cx24 * 2 + cx26) // 3), int((cy24 * 2 + cy26) // 3))
                AcupointsPosition[1][1][35] = (int((cx24 + cx26 * 2) // 3), int((cy24 + cy26 * 2) // 3))
                AcupointsPosition[1][1][36] = (int(cx26), int(cy26))
                AcupointsPosition[1][1][37] = (int((cx26 + cx28) // 2), int((cy28 + cy26 * 9) // 10))
                AcupointsPosition[1][1][38] = (int((cx26 + cx28) // 2), int((cy28 * 3 + cy26 * 7) // 10))
                AcupointsPosition[1][1][39] = (int((cx26 + cx28) // 2), int((cy28 + cy26) // 2))
                AcupointsPosition[1][1][40] = (int((cx26 + cx28) // 2), int((cy28 * 8 + cy26 * 2) // 10))
...
def FindAcupoint(image, acupointName="", LorR=0):
    if acupointName in Name[0]:
        img = cv2ImgAddText(image, acupointName, AcupointsPosition[0][LorR][Name.index(acupointName)][0],
                            AcupointsPosition[0][LorR][Name.index(acupointName)][1], (0, 0, 0), 20)
