...
from hooks.utils import playVideo, pause, updateImage
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.b_verticalLayout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        ...
        self.merideansBox.setStyleSheet(
            "ComboCheckBox {\n"
        ...
        self.acupointsBox.setStyleSheet(
            "ComboCheckBox {\n"
            "  background-color: #ffffff;\n"
            "  border: 1px solid #dcdfe6;\n"
            "  padding: 10px;\n"
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(100, 390, 281, 80))
        self.horizontalLayoutWidget.setObjectName("horizontalLayoutWidget")
        self.c_horizontalLayout = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget)
        ...
        self.pushButton.clicked.connect(playVideo)
        # QPushButton 2
        ...
        self.e_cameraImage.setStyleSheet(
        ...
        self.d_deepthImage.setStyleSheet(
            "background-color: rgb(221, 221, 221);\n" "border-radius:7px;"
        )
