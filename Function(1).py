        ...
        if Pose_Landmarks[12][2] < Pose_Landmarks[24][2]:
            if Pose_Landmarks[12][1] < Pose_Landmarks[11][1]:
                ...
                AcupointsPosition[0][0][4] = (
                    int((cx15 * 2 + cx13) // 3), int((cy15 * 2 + cy13) // 3))
                AcupointsPosition[0][0][5] = (
                    int(cx23), int((cy23 * 3 + cy11) // 4))
                AcupointsPosition[0][0][6] = (
                    int((cx23 * 3 + cx24) // 4), int((cy23 * 3 + cy24) // 4))
                AcupointsPosition[0][0][7] = (
                    int((cx23 * 3 + cx24) // 4), int((cy23 * 3 + cy11) // 4))
                AcupointsPosition[0][0][8] = (
                    int((cx11 * 3 + cx12) // 4), int((cy11 * 3 + cy12) // 4))
                AcupointsPosition[0][0][9] = (
                    int((cx23 * 3 + cx24) // 4), int((cy11 * 4 + cy12 + cy23 * 3) // 8))
                AcupointsPosition[0][0][10] = (
                    int((cx23 * 3 + cx24) // 4), int((cy11 * 5 + cy12 + cy23 * 6) // 12))
                AcupointsPosition[0][0][11] = (
                    int((cx23 * 3 + cx24) // 4), int((cy23 * 15 + cy12 + cy11 * 8) // 24))
                AcupointsPosition[0][0][12] = (
                    int((cx23 * 3 + cx24) // 4), int((cy23 * 6 + cy11 + cy24) // 8))
                AcupointsPosition[0][0][13] = (int(cx23), int(cy23))
                AcupointsPosition[0][0][14] = (
                    int(cx23), int((cy23 * 5 + cy11) // 6))
                AcupointsPosition[0][0][15] = (
                    int((cx23 + cx25) // 2), int((cy23 + cy25 * 2) // 3))
                AcupointsPosition[0][0][16] = (
                    int((cx23 + cx25) // 2), int((cy23 + cy25 * 5) // 6))
                AcupointsPosition[0][0][17] = (
                    int((cx25 * 2 + cx27) // 3), int((cy25 * 2 + cy27) // 3))
                AcupointsPosition[0][0][18] = (
                    int((cx25 + cx27 * 2) // 3), int((cy25 + cy27 * 2) // 3))
                ...
                AcupointsPosition[0][1][3] = (
                    int((cx14 + cx12 * 2) // 3), int((cy13 + cy11 * 2) // 3))
                AcupointsPosition[0][1][4] = (
                    int((cx24 * 3 + cx23) // 4), int((cy24 * 3 + cy11) // 4))
                AcupointsPosition[0][1][5] = (
                    int((cx24 * 3 + cx23) // 4), int((cy24 * 3 + cy23) // 4))
                AcupointsPosition[0][1][6] = (
                    int(cx24), int((cy24 * 3 + cy12) // 4))
                AcupointsPosition[0][1][7] = (
                    int((cx16 * 2 + cx14) // 3), int((cy16 * 2 + cy14) // 3))
                AcupointsPosition[0][1][8] = (
                    int((cx24 * 3 + cx23) // 4), int((cy24 * 15 + cy11 + cy12 * 8) // 24))
                AcupointsPosition[0][1][9] = (
                    int((cx24 * 3 + cx23) // 4), int((cy12 * 5 + cy11 + cy24 * 6) // 12))
                AcupointsPosition[0][1][10] = (
                    int((cx24 * 3 + cx23) // 4), int((cy12 * 4 + cy11 + cy24 * 3) // 8))
                AcupointsPosition[0][1][11] = (
                    int((cx12 * 3 + cx11) // 4), int((cy12 * 3 + cy11) // 4))
                AcupointsPosition[0][1][12] = (
                    int(cx24), int((cy24 * 5 + cy12) // 6))
                AcupointsPosition[0][1][13] = (int(cx24), int(cy24))
                AcupointsPosition[0][1][14] = (
                    int((cx24 * 3 + cx23) // 4), int((cy24 * 6 + cy12 + cy23) // 8))
                AcupointsPosition[0][1][15] = (
                    int((cx26 + cx28 * 2) // 3), int((cy26 + cy28 * 2) // 3))
                AcupointsPosition[0][1][16] = (
                    int((cx26 * 2 + cx28) // 3), int((cy26 * 2 + cy28) // 3))
                AcupointsPosition[0][1][17] = (
                    int((cx24 + cx26) // 2), int((cy24 + cy26 * 5) // 6))
                AcupointsPosition[0][1][18] = (
                    int((cx24 + cx26) // 2), int((cy24 + cy26 * 2) // 3))
                ...
                AcupointsPosition[1][0][5] = (
                    int(cx23), int((cy23 + cy11) // 2))
                AcupointsPosition[1][0][6] = (
                    int(cx23), int((cy23 * 3 + cy11*5) // 8))
                AcupointsPosition[1][0][7] = (
                    int(cx23), int((cy23 * 2 + cy11 * 6) // 8))
                AcupointsPosition[1][0][8] = (
                    int(cx23), int((cy23 + cy11 * 7) // 8))
                ...
                AcupointsPosition[1][0][12] = (
                    int((cx25 + cx27) // 2), int((cy27 + cy25 * 4) // 5))
                AcupointsPosition[1][0][13] = (
                    int((cx25 + cx27) // 2), int((cy27 * 2 + cy25 * 3) // 5))
                AcupointsPosition[1][0][14] = (
                    int((cx25 + cx27) // 2), int((cy27*3 + cy25 * 2) // 5))
                ...
                AcupointsPosition[1][1][4] = (
                    int(cx24), int((cy24 + cy12 * 7) // 8))
                AcupointsPosition[1][1][5] = (
                    int(cx24), int((cy24 * 2 + cy12 * 6) // 8))
                AcupointsPosition[1][1][6] = (
                    int(cx24), int((cy24 * 3 + cy12 * 5) // 8))
                AcupointsPosition[1][1][7] = (
                    int(cx24), int((cy24 + cy12) // 2))
                AcupointsPosition[1][1][8] = (
                    int(cx24), int((cy24 * 7 + cy12) // 8))
                AcupointsPosition[1][1][9] = (
                    int((cx26 + cx28) // 2), int((cy28 * 3 + cy26 * 2) // 5))
                AcupointsPosition[1][1][10] = (
                    int((cx26 + cx28) // 2), int((cy28 + cy26 * 4) // 5))
                AcupointsPosition[1][1][11] = (
                    int((cx24 + cx26 * 2) // 3), int((cy24 + cy26 * 2) // 3))
                AcupointsPosition[1][1][12] = (
                ...
                AcupointsPosition[1][1][18] = (
                    int((cx26 + cx28) // 2), int((cy28 * 2 + cy26 * 3) // 5))
...
def FindAcupoint(image, acupointName="", LorR=0):
    if acupointName in Name[0]:
        img = cv2ImgAddText(image, acupointName, AcupointsPosition[0][LorR][Name[LorR].index(
            acupointName)][0], AcupointsPosition[0][LorR][Name[LorR].index(acupointName)][1], (0, 0, 0), 20)
        cv.circle(img, AcupointsPosition[0][LorR][Name[LorR].index(
...
while (True):
    ...
    if depth_image_handle and color_image_handle:
        ...
        depth_color_image = pyK4A.transform_depth_to_color(
